				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<div class="row login_form">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="nameD" name="nameD" placeholder="webhook discord" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nom Discord'">
                            </div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<button onclick="inscription()" id="inscrire" value="inscrire" class="primary-btn">S'inscrire</button>
							</div>
					</div>
				</div>
			</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <script>
        function inscription(){
            ...
            $.ajax({
                url : 'ajaxInscription.php',
                type : 'POST',
                data : 'user=' + user + '&nameD=' + nameD + '&mdp='+mdp,
                dataType : 'html',
