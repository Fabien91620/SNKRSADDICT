	...
	<div class="container">
		<div class="row">
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-filter mt-50" style="margin: 0px">
						...
						<form action="#">
							<ul>
                                ...
                                <?php foreach($shoes as $data): ?>
								    <li class="filter-list"><a href="category.php?marque=<?php echo $data['Brand']; ?>" ><label><?php echo $data['Brand']; ?></label></a></li>
                                <?php endforeach; ?>
                            </ul>
						</form>
					</div>
							...
							<div class="single-product">
								...
								<div class="product-details">
                                    <?php if(isset($_GET['marque'])): ?>
									    <h6><a href="single-product.php?id=<?php echo $data['id'];?>&marque=<?php echo $data['id'];?>"><?php echo $data['Brand']." ".$data['Model']; ?></a></h6>
									<?php else: ?>
