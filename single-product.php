			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>Meilleur prix: <?php echo getBestPrice($data['Model']); ?></h2>
						<p>
                            <?php if(linkNike($data['Model'])[4] != ""){echo "<a href='".linkNike($data['Model'])[4]."'>Nike.com : ".linkNike($data['Model'])[3]."</a>";} ?>
                            <br>
                            <?php if(linkSneakers($data['Model'])[4] != ""){echo "<a href='".linkSneakers($data['Model'])[4]."'>Sneakersnstuff.com : ".linkSneakers($data['Model'])[3]."</a>";} ?>
                            <br>
                            <?php if(linkStockX($data['Model'])[4] != ""){echo "<a href='".linkStockX($data['Model'])[4]."'>StockX.com : ".linkStockX($data['Model'])[3]."</a>";} ?>
                        </p>
					</div>
				</div>
			</div>
